...
function watch(id) {
  if (document.getElementById(id) == img_puntual) {
    ...
    document.getElementById('emparejar').setAttribute('onclick','emparejar_al_an()')
    ...
    if (img_puntual) {
      ...
      if (escalable_id.includes(img_puntual.id)) {
        ...
        document.getElementById('emparejar').setAttribute('onclick','borrar_al_an()')
...
function emparejar_al_an() {
    ...
    // if (document.getElementById("emparejar").className === 'emparejar'){
...
if (img_w >= 0 && escalable_id.includes(img_w)) {
    console.log('Esta dentro del array');
        document.getElementById("emparejar").className =
          "emparejar";
        document
